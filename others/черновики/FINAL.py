...
class TargetTracker:
    def __init__(self):
        ...
        # ⏱ длительность слежения
        self.track_duration = 60.0
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if elapsed > self.track_duration:
                rospy.loginfo("60 секунд прошло → возвращаемся домой")
                break
            ...
            rospy.loginfo("Следим за человеком")
        ...
        # -------- ВОЗВРАТ --------
        rospy.loginfo("Возврат в (0,0)")

        self.navigate(x=0, y=0, z=self.height,
                      frame_id='aruco_map',
                      speed=0.5)
        rospy.sleep(5)
